...
pub const CODEX_DEVICE_CODE_URL: &str = "https://auth.openai.com/oauth/device/code";
...
pub async fn codex_device_code(
    ...
    let parsed: CodexDeviceCodeResponse = response.json().await?;
    Ok(Json(parsed))
}
...
pub async fn codex_token_poll(
    ...
    match error_code {
        "authorization_pending" => Ok(Json(CodexTokenPollResponse {
            status: "pending".into(),
            access_token: None,
            refresh_token: None,
            token_type: None,
        ...
        "expired_token" => Ok(Json(CodexTokenPollResponse {
            status: "expired".into(),
            access_token: None,
            refresh_token: None,
            token_type: None,
        ...
        "access_denied" => Ok(Json(CodexTokenPollResponse {
            status: "access_denied".into(),
            access_token: None,
            refresh_token: None,
            token_type: None,
